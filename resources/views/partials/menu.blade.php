<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('enviroment_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.enviroments.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/enviroments") || request()->is("admin/enviroments/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.enviroment.title') }}
                </a>
            </li>
        @endcan
        @can('yolo_api_access')
